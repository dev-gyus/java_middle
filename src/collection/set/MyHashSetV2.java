...
public class MyHashSetV2 {
    ...
    public boolean add(Object value) {
        LinkedList<Object> bucket = this.buckets[hashIndex(value)]; // O(1)
    ...
    public boolean contains(Object searchValue) {
        LinkedList<Object> bucket = this.buckets[hashIndex(searchValue)]; // O(1)
     ...
     * @return              저장 되어있는지 여부
     */
    public boolean remove(Object deleteValue) {
        LinkedList<Object> bucket = this.buckets[hashIndex(deleteValue)];
